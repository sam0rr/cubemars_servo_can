...
def buffer_append_int16(buffer: list, number: int) -> None:
    """
...
def buffer_append_uint16(buffer: list, number: int) -> None:
    """
...
def buffer_append_int32(buffer: list, number: int) -> None:
    """
...
def buffer_append_uint32(buffer: list, number: int) -> None:
    """
...
def buffer_append_int64(buffer: list, number: int) -> None:
    """
...
def buffer_append_uint64(buffer: list, number: int) -> None:
    """
